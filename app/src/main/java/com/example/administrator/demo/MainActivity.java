...
import com.example.administrator.demo.tagview.OnTagClickListener;
import com.example.administrator.demo.tagview.OnTagDeleteListener;
import com.example.administrator.demo.tagview.Tag;
import com.example.administrator.demo.tagview.TagView;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tagView.add(tag1);
        Tag tag131 = new Tag("TAG131");
        tagView.add(tag131);
        Tag tag111 = new Tag("TAG111");
        tagView.add(tag111);
        Tag tag121 = new Tag("TAG121");
        tagView.add(tag121);
